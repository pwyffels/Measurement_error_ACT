...
## the Average Patient
We are doing our simulation based on 'the average' patient from the study from Jain et al.
This means that we assume a patient with a weight of 93 kg with a measure baseline ACT (Activated Clotting Time) of 116 seconds. After receiving 33000 IU heparine the new measured ACT becomes 535 seconds. After Protamine administration the new measured ACT becomes 124.
...
Following this reasoning (see Bull-titration.. ref), the residual heparin (after protamin administration) can be calculated.
This corresponds to P(Heparin|kACT): the expexted Heparin for a measured (new) ACT value.
In our case: A new kACT of 126s would imply a residual heparin level of 630 IU. (formula: heparin = (126-116)/((555-116)/33000))
For a vizualisation of this calculation see the dark red arrows in fig B.
